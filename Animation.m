...
{
    [self showAnmationType:kCATransitionReveal withSubType:kCATransitionFromBottom duration:0.5f timingFuction:kCAMediaTimingFunctionEaseInEaseOut view:view];
}
+ (void)animationRevealFromTop:(UIView *)view
{
    [self showAnmationType:kCATransitionReveal withSubType:kCATransitionFromTop duration:0.5f timingFuction:kCAMediaTimingFunctionEaseInEaseOut view:view];
}
+ (void)animationRevealFromLeft:(UIView *)view
{
    [self showAnmationType:kCATransitionReveal withSubType:kCATransitionFromLeft duration:0.5f timingFuction:kCAMediaTimingFunctionEaseInEaseOut view:view];
}
+ (void)animationRevealFromRight:(UIView *)view
{
    [self showAnmationType:kCATransitionReveal withSubType:kCATransitionFromRight duration:0.5f timingFuction:kCAMediaTimingFunctionEaseInEaseOut view:view];
}
+ (void)animationPushUp:(UIView *)view
{
    [self showAnmationType:kCATransitionPush withSubType:kCATransitionFromTop duration:0.35f timingFuction:kCAMediaTimingFunctionEaseOut view:view];
}
+ (void)animationPushDown:(UIView *)view
{
    [self showAnmationType:kCATransitionPush withSubType:kCATransitionFromBottom duration:0.35f timingFuction:kCAMediaTimingFunctionEaseOut view:view];
}
+ (void)animationPushLeft:(UIView *)view
{
     [self showAnmationType:kCATransitionPush withSubType:kCATransitionFromLeft duration:0.35f timingFuction:kCAMediaTimingFunctionEaseOut view:view];
}
+ (void)animationPushRight:(UIView *)view
{
     [self showAnmationType:kCATransitionPush withSubType:kCATransitionFromRight duration:0.35f timingFuction:kCAMediaTimingFunctionEaseOut view:view];
}

//PresentModalViewController
+ (void)animationMoveUp:(UIView *)view duration:(CFTimeInterval)duration
{
    [self showAnmationType:kCATransitionMoveIn withSubType:kCATransitionFromTop duration:duration timingFuction:kCAMediaTimingFunctionEaseInEaseOut view:view];
}

//渐隐渐退
+(void)animationEaseIn:(UIView*)view
{
    [self showAnmationType:kCATransitionFade withSubType:nil duration:0.35f timingFuction:kCAMediaTimingFunctionEaseIn view:view];
}
+(void)animationEaseOut:(UIView *)view
{
    [self showAnmationType:kCATransitionFade withSubType:nil duration:0.35f timingFuction:kCAMediaTimingFunctionEaseOut view:view];
}
/**
 *  UIViewAnimation
 *
 ...
 */
+ (void)showAnmationWIthDuration:(CFTimeInterval)duration withCurve:(UIViewAnimationCurve )curve withFromDiection:(UIViewAnimationTransition )direction withCache:(BOOL)cache withView:(UIView *)view
{
    [UIView beginAnimations:nil context:nil];
    [UIView setAnimationCurve:curve];
    [UIView setAnimationDuration:curve];
    [UIView setAnimationTransition:direction forView:view cache:cache];
    [UIView commitAnimations];
}

+ (void)animationFlipFromLeft:(UIView *)view
{
    [self showAnmationWIthDuration:0.35f withCurve:UIViewAnimationCurveEaseOut withFromDiection:UIViewAnimationTransitionFlipFromLeft withCache:NO withView:view];
}
+ (void)animationFlipFromRigh:(UIView *)view
{
    [self showAnmationWIthDuration:0.35f withCurve:UIViewAnimationCurveEaseOut withFromDiection:UIViewAnimationTransitionFlipFromRight withCache:NO withView:view];
}
+ (void)animationCurlUp:(UIView *)view
{
    [self showAnmationWIthDuration:0.35f withCurve:UIViewAnimationCurveEaseOut withFromDiection:UIViewAnimationTransitionCurlUp withCache:NO withView:view];
}
+ (void)animationCurlDown:(UIView *)view
{
    [self showAnmationWIthDuration:0.35f withCurve:UIViewAnimationCurveEaseOut withFromDiection:UIViewAnimationTransitionCurlDown withCache:NO withView:view];
}
